...
const devConfig = {
  MONGO_URL: 'mongodb://localhost:27017/makeanodejsapi-dev'
};
...
_mongoose2.default.connection.once('open', () => console.log('Mongodb connected!')).on('error', err => console.log(err));
